...
// TODO: Something about the server has an unfortunate habit of trashing files generated by ImageSort
// at least on Windows, Linux is untested. I suspect a path error but converting did not seem to solve
